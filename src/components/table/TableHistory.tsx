...
export default function CustomPaginationActionsTable({ value }: any) {
  const [page, setPage] = React.useState(0);
  const [rowsPerPage, setRowsPerPage] = React.useState(5);

  const historyList = value.detail_progress.date.map(
    (detail: any, index: any) => ({
      date:value.detail_progress.date[index],
      footStep:value.detail_progress.footStep[index],
